...
INSERT INTO tb_funcionario(nome, telefone, tipo_funcionario, hospital_id) VALUES ('Jose Luiz Datena', '4002-8922', 1);

INSERT INTO tb_consulta(exame, data_exame, diagnostico, receita, status, funcionario_id, hospital_id, paciente_cpf) VALUES ('Raio-X', '19/11/2023', 'Ernea de Disco', 'Tramal', 'REALIZADO', 1, 1, '123.123.123-4');
INSERT INTO tb_consulta(exame, data_exame, diagnostico, receita, status, funcionario_id, hospital_id, paciente_cpf) VALUES ('Raio-X', '13/11/2023', 'Pneumonia', 'Lorazepan', 'MARCADO', 1, 2, '574.568.968-3');
